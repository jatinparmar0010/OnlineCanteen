...
<asp:Content ID="Content2" ContentPlaceHolderID="head" Runat="Server">
    <link href="forgetStyleSheet.css" rel="stylesheet" type="text/css" />
</asp:Content>
    ...
    <div id="fomain">
        <h2>
            ...
            <asp:Button ID="Button1" runat="server" Text="SEND CODE" 
                ...
                <br /><br />  
            <asp:HyperLink class="slink" ID="HyperLink2" runat="server" NavigateUrl="login.aspx" Font-Size="Large">Login!</asp:HyperLink>
            <br /><br />    
